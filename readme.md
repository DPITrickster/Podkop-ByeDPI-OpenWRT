...
```sh
(cd /tmp && curl -LO https://github.com/DPITrickster/ByeDPI-OpenWrt/releases/download/v0.17.3-v25.12.0/byedpi_0.17.3-r1_aarch64_cortex-a53.apk)
```
...
```sh
apk del byedpi
apk add --allow-untrusted /tmp/byedpi_0.17.3-r1_aarch64_cortex-a53.apk
```
...
- **[romanvht](https://github.com/romanvht)** за возможность тестировать стратегии и возможность [поучения реальных IP](https://github.com/itdoginfo/podkop/pull/361)
